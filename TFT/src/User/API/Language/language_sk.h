...
#define _LANGUAGE_SK_H_
    ...
    #define SK_ONBOARDSD            "SD karta v doske"
    #define SK_READ_ONBOARDSD_ERROR "Chyba pri načítaní SD karty na doske!"
    #define SK_FILAMENT_SENSOR      "Filament sensor"
    ...
    #define SK_PRINT_ACCELERATION       "Akcelerácia Tlače"
