...
#define _LANGUAGE_HU_H_
    ...
    #define HU_SEND_START_GCODE     "G-Kód futtatása nyomtatás előtt"
    #define HU_SEND_END_GCODE       "G-Kód futtatása nyomtatás után"
    ...
    #define HU_PRINT_ACCELERATION       "Nyomtatási Gyorsulás"
    #define HU_RETRACT_ACCELERATION     "Visszahúzás Gyorsulás"
    #define HU_TRAVEL_ACCELERATION      "Utazási Gyorsulás"
    #define HU_BUMP_SENSITIVITY         "TMC ütközés érzékenység"
    #define HU_RESET                    "Visszaállítás"
    #define HU_RESET_SETTINGS           "Minden beállítás visszaáll az alapértelmezett értékre. Folytatja?"
